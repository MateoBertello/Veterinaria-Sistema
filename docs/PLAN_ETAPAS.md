...
| 9 — Hardening | En curso (S1 ✅) | Matriz completa en `docs/MATRIZ_RN_TESTS.md`: 167 RN, 123 con test, 44 brechas clasificadas | — | Se ejecuta como serie de 11 sub-sesiones (prompts en `docs/PROMPTS_ETAPA9.md`). S1 (2026-07-06): suites verdes (typecheck + 345 unit + 137 integración + 247 web), matriz RN→test generada, deuda consolidada en TODO.md (DT-4..DT-9; RN-EC9 y logs de debug verificados como resueltos). |
